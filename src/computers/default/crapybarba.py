...
class ScrapybaraBrowser:
    """
    Scrapybara provides cloud-based virtual desktops and browsers.
    Learn more at https://scrapybara.com. Try OpenAI CUA at https://computer.new
    or view the CUA Quickstart at https://computer.new/cua.
    """
    ...
    def click(self, x: int, y: int, button: str = "left") -> None:
        ...
        self.instance.computer(
            action="click_mouse", click_type="click", button=button, coordinates=[x, y], num_clicks=1
        )

    def double_click(self, x: int, y: int) -> None:
        self.instance.computer(
            action="click_mouse", click_type="click", button="left", coordinates=[x, y], num_clicks=2
        )

    def scroll(self, x: int, y: int, scroll_x: int, scroll_y: int) -> None:
        self.instance.computer(
            action="scroll", coordinates=[x, y], delta_x=scroll_x // 20, delta_y=scroll_y // 20
        )
...
class ScrapybaraUbuntu:
    """
    Cloud-based virtual desktop using Scrapybara on Ubuntu.
    OpenAI CUA is available at https://computer.new with Quickstart docs.
    """
